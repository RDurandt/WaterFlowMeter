...
telegram_bot.sendMessage(chat_id, str("Last Rotations: ")+str(tel_lastvol)+chr(13)+str("\n\rStart: ")+str(tel_starttime)+str("\n\rEnd: ")+str(tel_endtime)+str("\n\rDuration run: ")+str(tel_duration))
telegram_bot = telepot.Bot('Fill your own in here')
